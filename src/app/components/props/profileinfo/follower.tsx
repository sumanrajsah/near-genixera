...
export const FollowerList = ({List,userData}:{List:data[],userData:usersProfile}) =>{
  const searchParams = useSearchParams();
  const searchTerm = searchParams.get('followers');
      ...
      {(searchTerm === 'true') && <div className="follower-body">
       { true ?<div className="follower-cont">
        <div className="follower-top">
         ...
         <div className="followers-box" key={index} onClick={(e)=>seeProfile(data?.username)}>
